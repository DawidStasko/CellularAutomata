<p>Desktop application to explore a probelm of cellular automata. <br />This implementation is a proprietary solution based on existing mathematical models.</p>
